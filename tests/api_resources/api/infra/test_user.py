...
from cortex_amq.types.api.infra import User, UserListResponse
...
class TestUser:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve(self, client: CortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve(self, client: CortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve(self, client: CortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve(self, client: CortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list(self, client: CortexAmq) -> None:
        user = client.api.infra.user.list()
        assert_matches_type(UserListResponse, user, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list(self, client: CortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list(self, client: CortexAmq) -> None:
...
class TestAsyncUser:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncCortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncCortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncCortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve(self, async_client: AsyncCortexAmq) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list(self, async_client: AsyncCortexAmq) -> None:
        user = await async_client.api.infra.user.list()
        assert_matches_type(UserListResponse, user, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list(self, async_client: AsyncCortexAmq) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncCortexAmq) -> None:
